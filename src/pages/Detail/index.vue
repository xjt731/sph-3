      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="count" @blur="changeNum(count)" />
                <a href="javascript:" class="plus" @click="count>=1?count++:count">+</a>
                <a href="javascript:" class="mins" @click="count>=2?count--:count">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    //点谁谁变绿
    changeChecked(saleAttrValue, arrayList) {
      //排他操作
      //把全部的属性值isChecked属性变为0
      //只有点击的属性值
      arrayList.forEach(item => {
        item.isChecked = 0;
        if (item.id == saleAttrValue.id) {
